...
> 自动生成于 2026-05-16 | 由 code-indexer 脚本维护
> **本文件由脚本自动生成，严禁手动编辑。**
...
| `internal/matcher/ls_engine.go` | 1006 | 3 | **1** | 9 | [internal_matcher_ls_engine_go_index.md](internal_matcher_ls_engine_go_index.md) |
| `internal/matcher/league_alias.go` | 963 | 4 | 0 | 0 | [internal_matcher_league_alias_go_index.md](internal_matcher_league_alias_go_index.md) |
| `internal/matcher/universal_engine.go` | 855 | 0 | 0 | 0 | [internal_matcher_universal_engine_go_index.md](internal_matcher_universal_engine_go_index.md) |
...
| `internal/matcher/league_features.go` | 715 | 1 | **1** | 5 | [internal_matcher_league_features_go_index.md](internal_matcher_league_features_go_index.md) |
| `direct_match_export.py` | 706 | 13 | **1** | 0 | [direct_match_export_py_index.md](direct_match_export_py_index.md) |
| `cmd/server/main.go` | 698 | 12 | 0 | 0 | [cmd_server_main_go_index.md](cmd_server_main_go_index.md) |
...
| `python/evidence_first_baseline_eval.py` | 522 | 13 | 0 | 0 | [python_evidence_first_baseline_eval_py_index.md](python_evidence_first_baseline_eval_py_index.md) |
| `internal/matcher/fs_model.go` | 519 | 0 | 0 | 0 | [internal_matcher_fs_model_go_index.md](internal_matcher_fs_model_go_index.md) |
| `internal/matcher/evidence_event_matcher.go` | 492 | 0 | 0 | 0 | [internal_matcher_evidence_event_matcher_go_index.md](internal_matcher_evidence_event_matcher_go_index.md) |
| `internal/matcher/team_player.go` | 487 | 0 | 0 | 0 | [internal_matcher_team_player_go_index.md](internal_matcher_team_player_go_index.md) |
| `python/fetch_2026_data.py` | 480 | 7 | 0 | 0 | [python_fetch_2026_data_py_index.md](python_fetch_2026_data_py_index.md) |
| `internal/matcher/dense_blocking.go` | 450 | 1 | 0 | 0 | [internal_matcher_dense_blocking_go_index.md](internal_matcher_dense_blocking_go_index.md) |
| `internal/matcher/known_map_validator.go` | 433 | 3 | 0 | 0 | [internal_matcher_known_map_validator_go_index.md](internal_matcher_known_map_validator_go_index.md) |
...
| `internal/db/alias_store.go` | 402 | 3 | 0 | 0 | [internal_db_alias_store_go_index.md](internal_db_alias_store_go_index.md) |
...
| `internal/db/ls_adapter.go` | 208 | 1 |
| `internal/matcher/league_alias_test.go` | 206 | 6 |
| `tasks/tsk-97cf2032-032/deliverables/league_alias_test.go` | 206 | 6 |
| `internal/matcher/league.go` | 188 | 0 |
| `internal/db/tunnel.go` | 180 | 0 |
| `internal/matcher/reverse_confirm.go` | 180 | 0 |
| `tasks/tsk-97cf2032-032/deliverables/league.go` | 179 | 0 |
| `python/db/connector.py` | 172 | 3 |
| `internal/matcher/evidence_event_matcher_test.go` | 159 | 6 |
| `tasks/tsk-c93a8ede-fc7/deliverables/models.go` | 123 | 0 |
| `internal/db/models.go` | 121 | 0 |
| `internal/config/config.go` | 76 | 0 |
| `internal/db/canonical_models.go` | 67 | 0 |
| `internal/matcher/diag_test.go` | 44 | 1 |
| `python/db/__init__.py` | 2 | 0 |
| `python/__init__.py` | 1 | 0 |
