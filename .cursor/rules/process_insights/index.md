...
| PI-006 | Evidence-First 比赛级匹配流程 | v1.34 | internal/matcher, internal/db, cmd, docs | 2026-05-16 | [PI-006](PI-006_evidence_first_matching_flow.md) |
| PI-007 | Evidence-First P0 基线冻结与评估集流程 | v1.7 | python, python/data, docs, internal/matcher | 2026-05-16 | [PI-007](PI-007_evidence_first_p0_baseline.md) |
...
| 废弃洞察 | 将 `status` 改为 `deprecated`，文档顶部添加废弃警告，并迁移到本文